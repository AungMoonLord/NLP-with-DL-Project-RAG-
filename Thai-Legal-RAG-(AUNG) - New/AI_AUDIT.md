...
|---|---|---|---|
| 1 | **Corpus Chunking Strategy:** ตัด Chunk แบบ Token-aware ขนาด ~256 tokens พร้อม Overlap | Human | กฎหมายไทยเขียนเป็นรายมาตรา หากตัดสั้นเกินไป (เช่น 256) นิยามและข้อยกเว้นจะขาดออกจากกัน หากตัดยาวเกินไป (เช่น 1024) Vector จะเฉลี่ยความหมายกว้างเกินไปจน Retrieval ดึงมาตราที่เจาะจงไม่เจอ |
